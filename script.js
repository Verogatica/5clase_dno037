...
*/
Papa.parse("https://raw.githubusercontent.com/Verogatica/5clase_dno037/main/indice-uso-cobre.csv", {
    download: true,
    header: true,
    dynamicTyping: true,
                ...
                new Chart(document.querySelector("#grafico").getContext("2d"), {
                    ...
                    data: {
                        ...
                        datasets: [
                            {
                                data: indice,
                                backgroundColor: "rgba(2, 62, 138, .2)",
                                borderColor: "rgba(0, 119, 182, .5)",
                                pointRadius: 3.5,
                                borderWidth: 2.5,
                                lineTension: 0,
                            },
